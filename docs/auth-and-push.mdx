...
description: Authenticate to the Xerg API, push audit summaries, and understand how hosted Pro features use workspace API keys.
---
...
3. connect a remote client to [hosted MCP](/hosted-mcp)
