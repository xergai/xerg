...
description: Configure Cursor, Claude Code, or another client for Xerg's hosted MCP server after your first pushed audit.
---
...
- asks whether you want Cursor, Claude Code, or another client
