...
This directory contains the current planning set for Xerg after narrowing scope from the original v1 concept.

Files:

- `xerg-product-definition.md`: what Xerg is now, what it is not yet, and what governs product decisions
