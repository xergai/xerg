...
5. Publish the first beta package and verify `npx @xerg/cli --help` outside the repo.
...
1. Create or update a changeset for `@xerg/cli`.
...
9. Verify the package on a clean machine with `npx @xerg/cli --help`.
